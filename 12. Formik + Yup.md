...
5. **Kintamūjų laikymas**: Laikykite *initialValues* ir *validationSchema* ne renderio viduje. Galite laikyti virš komponento arba geriausia iškelti į atskirą failą.
